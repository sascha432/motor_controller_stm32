...
/* Custom UI fonts (generated by src/fonts/generate_fonts.py).
 * LV_FONT_CUSTOM_DECLARE is expanded by LVGL so the fonts are visible to
 * LVGL internals as well (e.g. the LV_FONT_DEFAULT used in lv_style.c). */
#define LV_FONT_CUSTOM_DECLARE \
    LV_FONT_DECLARE(lv_font_montserrat_12_ui) \
    LV_FONT_DECLARE(lv_font_montserrat_14_ui) \
    LV_FONT_DECLARE(lv_font_montserrat_18_ui) \
    LV_FONT_DECLARE(lv_font_montserrat_24_ui)

/* All UI labels set their font explicitly; this only replaces the built-in
 * default that LVGL would otherwise use (and which no longer exists). */
#define LV_FONT_DEFAULT &lv_font_montserrat_14_ui
