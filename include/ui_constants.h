...
struct UIConstants
{
    ...
    static constexpr uint32_t kSelectKpSteps = 50;                          // Steps for Kp selection
    static constexpr uint32_t kSelectKiSteps = 50;                          // Steps for Ki selection
    static constexpr uint32_t kSelectKdSteps = 5;                           // Steps for Kd selection
    ...
    static constexpr uint32_t kStepsAntiWindup = kAntiWindupFactor / 25;    // Steps for anti-windup selection
    ...
    static constexpr uint32_t kResetFirmwareLongPressTimeout = 5000;        // Long press duration in milliseconds before resetting firmware
};
