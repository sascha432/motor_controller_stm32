...
/* USER CODE BEGIN 0 */
volatile uint32_t g_usb_cb_setup = 0;
volatile uint32_t g_usb_cb_data_out = 0;
volatile uint32_t g_usb_cb_data_in = 0;
volatile uint32_t g_usb_cb_sof = 0;
volatile uint32_t g_usb_cb_reset = 0;
volatile uint32_t g_usb_cb_suspend = 0;
volatile uint32_t g_usb_cb_resume = 0;
volatile uint32_t g_usb_cb_connect = 0;
volatile uint32_t g_usb_cb_disconnect = 0;
